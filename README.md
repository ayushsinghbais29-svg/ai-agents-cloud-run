...
Focuses on designing, building, and deploying production-ready AI agents using Gemini and the Agent Development Kit (ADK). Participants learn how to move from prototypes to scalable, serverless AI agents running on Cloud Run.
